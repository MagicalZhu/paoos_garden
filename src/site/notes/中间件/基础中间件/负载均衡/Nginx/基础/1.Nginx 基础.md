---
{"dg-publish":true,"permalink":"////nginx//1-nginx/","title":"Nginx 基础"}
---
...
通过 `ps -ef | grep nginx` 可以看到有一个 matser进程,还有一个 worker 子进程,它们两个有以下的区别
...
![Nginx 请求响应流程](/img/user/中间件/基础中间件/负载均衡/Nginx/基础/image/nginx请求响应流程.webp)
